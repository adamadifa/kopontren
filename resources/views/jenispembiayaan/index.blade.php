        ...
        <div class="content-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <a href="/jenispembiayaan/create" class="btn btn-primary"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-report__action w-56">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <a class="ml-1"
                                                            href="/jenispembiayaan/{{ \Crypt::encrypt($d->kode_pembiayaan) }}/edit"><i
                                                                class="feather icon-edit"></i></a>
                                                        <form method="POST" class="deleteform"
                                                            action="/jenispembiayaan/{{ \Crypt::encrypt($d->kode_pembiayaan) }}/delete">
                                                            @csrf
                                                            @method('DELETE')
