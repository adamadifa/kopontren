 ...
 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
     <div class="navbar-header">
         <ul class="nav navbar-nav flex-row">
             <li class="nav-item mr-auto"><a class="navbar-brand"
                     href="{{ asset('html/ltr/vertical-menu-template/index.html') }}">
     ...
     <div class="main-menu-content">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
             <li class=" nav-item"><a href="/dashboard"><i class="feather icon-home"></i><span
             ...
             <li class=" nav-item">
                 ...
                 <ul class="menu-content">
                     <li class="{{ request()->is(['anggota', 'anggota/*']) ? 'active' : '' }}"><a href="/anggota"><i
                                 class="feather icon-users"></i><span class="menu-item">Anggota</span></a></li>
                     <li class="{{ request()->is(['jenissimpanan', 'jenissimpanan/*']) ? 'active' : '' }}"><a
                             href="/jenissimpanan"><i class="feather icon-book"></i><span class="menu-item">Jenis
                                 Simpanan</span></a></li>
                     <li class="{{ request()->is(['tabungan', 'tabungan/*']) ? 'active' : '' }}"><a
                             href="/tabungan"><i class="feather icon-book"></i><span class="menu-item">Jenis
                                 Tabungan</span></a>
                     </li>
                     <li class="{{ request()->is(['jenispembiayaan', 'jenispembiayaan/*']) ? 'active' : '' }}"><a
                             href="/jenispembiayaan"><i class="fa fa-balance-scale"></i><span
                                 class="menu-item">Jenis
                                 Pembiayaan</span></a>
                     </li>
                 </ul>
             </li>
             ...
             <li class=" nav-item {{ request()->is(['pembiayaan', 'pembiayaan/*']) ? 'active' : '' }}">
                 <a href="/pembiayaan"><i class="fa fa-balance-scale"></i><span
                         class="menu-title">Pembiayaan</span></a>
             </li>
         </ul>
     </div>
 </div>
