    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Detail Tabungan</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/rekening">Tabungan</a></li>
                            <li class="breadcrumb-item"><a href="#">Detail Tabungan</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-md-4">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $anggota->kode_tabungan }} - {{ $anggota->nama_tabungan }}</td>
                                        </tr>
                                        <tr>
                                            <td class="font-weight-bold"><i class="feather icon-book mr-1"></i>Saldo
                                            </td>
                                            <td style="text-align: right; font-weight:bold">
                                                {{ number_format($saldotabungan->saldo, '0', '', '.') }}</td>
                                        </tr>
                                    </table>
        ...
        <div class="col-md-12 col-12 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ $datatabungan->links('vendor.pagination.vuexy') }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="frmSimpanan" action="/rekening/storemutasi" class="validate-form">
                    @csrf
                    <input type="hidden" name="no_rekening" id="no_rekening" value="{{ \Crypt::encrypt($anggota->no_rekening) }}">
                    ...
                    <input type="hidden" name="kode_tabungan" id="kode_tabungan" value="{{ $anggota->kode_tabungan }}">
                    <div class="col-12">
