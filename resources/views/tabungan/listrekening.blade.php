                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class=" form-label-group position-relative has-icon-left">
                                            <input type="text" value="{{ Request('nama') }}" id="nama" name="nama"
                                                class="form-control" name="fname-floating-icon"
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-primary"><i
                                                class="feather icon-search mr-1"></i>Search</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="/rekening/{{ Crypt::encrypt($d->no_rekening) }}/show"
                                                    class="primary"><i class="feather icon-book"></i></a>
                                                <form method="POST" class="deleteform"
                                                    action="/rekening/{{ Crypt::encrypt($d->no_rekening) }}/delete">
                                                    @csrf
                                                    @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="frmSimpanan" action="/rekening/store" class="frmRekening">
                        @csrf
                        <div class="col-12">
                            <x-inputtext label="No. Rekening (Auto)" field="no_rekening" icon="feather icon-maximize"
                                readonly="true" />
                        </div>
                        <div class="col-12">
