...
<div class="intro-y col-span-12 flex justify-between flex-wrap sm:flex-no-wrap items-center mt-2">
    <div class="flex flex-wrap">
        <a href="/tabungan/create" class="button text-white bg-theme-3 shadow-md mr-2">Tambah Jenis Tabungan</a>
    ...
    <table class="table table-report -mt-2">
        <thead>
            <tr>
                ...
                <th class="whitespace-no-wrap">KODE TABUNGAN</th>
                <th class="whitespace-no-wrap">NAMA TABUNGAN</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex justify-center">
                            <a class="flex items-center text-theme-1" href="/tabungan/{{\Crypt::encrypt($d->kode_tabungan)}}/edit"> <i data-feather="edit" class="w-4 h-4 mr-1"></i></a>
                            <form class="flex items-center text-theme-6" method="POST" id="deleteform" action="/tabungan/{{Crypt::encrypt($d->kode_tabungan)}}/delete">
                                @csrf
                                @method('DELETE')
