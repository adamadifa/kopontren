                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="/pembiayaan/{{ Crypt::encrypt($d->no_transaksi) }}/cetak" class="primary"><i class="feather icon-printer"></i></a>
                                                    <form method="POST" class="deleteform" action="/pembiayaan/{{ Crypt::encrypt($d->no_transaksi) }}/delete">
                                                        @csrf
                                                        @method('DELETE')
